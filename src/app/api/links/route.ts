...
export async function POST(req: Request) {
  ...
  const link = await prisma.link.create({
    data: {
      ...
      cloaked: parsed.data.cloaked ?? false,
      ogTitle: parsed.data.ogTitle,
      ogDescription: parsed.data.ogDescription,
      ogImage: parsed.data.ogImage,
      abTestUrl: parsed.data.abTestUrl || undefined,
      abTestTraffic: parsed.data.abTestTraffic,
      deviceMobileUrl: parsed.data.deviceMobileUrl,
      deviceDesktopUrl: parsed.data.deviceDesktopUrl,
      deviceTabletUrl: parsed.data.deviceTabletUrl,
      geoOverrides: parsed.data.geoOverrides ?? '[]',
      deepLinkIos: parsed.data.deepLinkIos,
      deepLinkAndroid: parsed.data.deepLinkAndroid,
    },
  })
