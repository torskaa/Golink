  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 select-none',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-border-default bg-bg-default shadow-sm hover:bg-bg-subtle hover:text-content-emphasis active:scale-[0.97]',
        secondary: 'bg-bg-subtle text-content-emphasis shadow-sm hover:bg-bg-muted',
        ghost: 'hover:bg-bg-subtle hover:text-content-emphasis',
